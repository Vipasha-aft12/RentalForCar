import './NoCreditCard.css';
export default function NoCreditCard() {
  return (
    <section className="hero">
      <div className="wrap" style={{maxWidth: '860px'}}>
        ...
        <p className="sub" style={{maxWidth: '48ch'}}>
          A missing credit card doesn’t have to end the trip — but the rules are strict and local, so it pays to check first.
        </p>
        <div className="cta">
