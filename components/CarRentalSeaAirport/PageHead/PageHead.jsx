         ...
         <div className="detail-layout">
           ...
           <aside id="search" className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Seattle-Tacoma International Airport (SEA)">
               ...
               <div className="field" data-validate="l-sea-airport-pickup">
                 <label htmlFor="l-sea-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-sea-airport-pickup" type="text" value="Seattle-Tacoma International Airport (SEA)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-sea-airport-from">
                  <label htmlFor="l-sea-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-sea-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-sea-airport-to">
                  <label htmlFor="l-sea-airport-to">
                    Return date & time
                  </label>
                  <input id="l-sea-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-sea-airport-age">
                    Driver age
                  </label>
                   <select id="l-sea-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-sea-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-sea-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
