       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           <div className="detail-main">
             ...
             <p className="lede">
              The busiest airport in the world has a single rental centre reached by its own train. Collection is straightforward; the Atlanta traffic afterwards is the part to plan around.
            </p>
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Hartsfield-Jackson Atlanta International Airport (ATL)">
               <p className="eyebrow">
                Book at ATL
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-atl-airport-pickup">
                 <label htmlFor="l-atl-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-atl-airport-pickup" type="text" value="Hartsfield-Jackson Atlanta International Airport (ATL)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-atl-airport-from">
                  <label htmlFor="l-atl-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-atl-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-atl-airport-to">
                  <label htmlFor="l-atl-airport-to">
                    Return date & time
                  </label>
                  <input id="l-atl-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-atl-airport-age">
                    Driver age
                  </label>
                   <select id="l-atl-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-atl-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-atl-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
