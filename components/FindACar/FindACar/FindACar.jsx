      ...
      <div className="wrap">
        <div className="hero-grid">
          <div>
            ...
            <p className="sub">
              Tell us where and when. We’ll find the car and confirm the counter rules for that exact branch before you commit.
            </p>
          ...
          <div>
            ...
            <div className="media" data-label="Cars / road photo"><img src="https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=1200&q=70" alt="Cars / road — RentalForCar" loading="lazy" width="1200" height="750" /></div>
          </div>
        </div>
      </div>
    </section>
