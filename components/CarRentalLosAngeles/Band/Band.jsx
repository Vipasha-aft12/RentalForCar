    ...
    <section className="band mint">
       <div className="wrap" style={{maxWidth: '900px'}}>
         ...
         <div className="faq" style={{marginBottom: '40px'}}>
           <details>
             <summary>
              Is a car essential in Los Angeles?
            </summary>
             <div className="faq-a">
              <p>
                For most visitors, yes. LA is spread over an enormous area and transit between the places people actually visit is slow. The exception is a trip confined to one neighbourhood.
              </p>
            </div>
           </details>
           <details>
             <summary>
              What should I know about LA tolls and carpool lanes?
            </summary>
             <div className="faq-a">
              <p>
                The ExpressLanes on the I-110 and I-405 need a transponder — the free general lanes run alongside, so you can avoid them entirely. Carpool lanes are free but require the stated number of occupants, and the fine for misuse is steep.
              </p>
            </div>
           </details>
         </div>
