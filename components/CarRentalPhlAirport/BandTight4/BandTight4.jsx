    ...
    <section className="band-tight">
       <div className="wrap">
         <div className="book-card" style={{maxWidth: '760px', margin: '0 auto', textAlign: 'center'}}>
           <h2 className="h-3">
            Want us to check PHL for your dates?
          </h2>
           <p className="card-note" style={{margin: '8px 0 18px'}}>
            Tell the desk your dates and the class you want and we will check what our rental partners have at PHL Airport, with the deposit and the counter balance quoted separately.
          </p>
