       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           <div className="detail-main">
             ...
             <p className="lede">
              SFO puts all its rental companies in one centre reached by AirTrain. The thing to get right here is tolls — the Bay Area bridges take no cash at all.
            </p>
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="San Francisco International Airport (SFO)">
               <p className="eyebrow">
                Book at SFO
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-sfo-airport-pickup">
                 <label htmlFor="l-sfo-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-sfo-airport-pickup" type="text" value="San Francisco International Airport (SFO)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-sfo-airport-from">
                  <label htmlFor="l-sfo-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-sfo-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-sfo-airport-to">
                  <label htmlFor="l-sfo-airport-to">
                    Return date & time
                  </label>
                  <input id="l-sfo-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-sfo-airport-age">
                    Driver age
                  </label>
                   <select id="l-sfo-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-sfo-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-sfo-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
