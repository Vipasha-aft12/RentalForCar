  ...
  return (
    <section className="hero">
      <div className="wrap" style={{maxWidth: '900px'}}>
        <p className="eyebrow">
          Independent travel agency · not Dollar
        </p>
        <h1>
          Renting a Dollar-class car through
          <span className="hl">
            RentalForCar
          </span>
        </h1>
        <p className="sub" style={{maxWidth: '50ch'}}>
          Want a rental in the class Dollar is known for? We’re an independent agency — we arrange new rentals with third-party rental companies and confirm the counter rules for your exact branch before you book.
        </p>
        <div className="cta">
