import './AccessibleVans.css';
export default function AccessibleVans() {
  return (
    <section className="hero">
      <div className="wrap" style={{maxWidth: '860px'}}>
        ...
        <h1>
          Vehicles that meet the need
        </h1>
        <p className="sub" style={{maxWidth: '48ch'}}>
          Accessible vehicles are limited stock and need arranging ahead — the earlier you tell us, the better we can match it.
        </p>
        <div className="cta">
