    ...
    <section className="band mint">
       <div className="wrap" style={{maxWidth: '900px'}}>
         ...
         <div className="faq" style={{marginBottom: '40px'}}>
           <details>
             <summary>
              Do I need a car if I am staying on the Strip?
            </summary>
             <div className="faq-a">
              <p>
                Not for the Strip itself, where walking and the monorail cover it and resort parking now carries a daily fee at most properties. Rent for the trips out — the Grand Canyon, Zion, Death Valley, Red Rock.
              </p>
            </div>
           </details>
           <details>
             <summary>
              Does resort parking cost extra?
            </summary>
             <div className="faq-a">
              <p>
                At most large Strip resorts, yes, as a daily charge separate from your rental. Confirm it with your hotel before deciding how long you need the car, because a week of resort parking adds up quickly.
              </p>
            </div>
           </details>
         </div>
