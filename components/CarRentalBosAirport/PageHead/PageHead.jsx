       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           <div className="detail-main">
             ...
             <p className="lede">
              Logan now consolidates its rental companies into one centre, which has made collection far simpler. Driving in Boston afterwards is its own subject — and mostly one to avoid.
            </p>
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Boston Logan International Airport (BOS)">
               <p className="eyebrow">
                Book at BOS
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-bos-airport-pickup">
                 <label htmlFor="l-bos-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-bos-airport-pickup" type="text" value="Boston Logan International Airport (BOS)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-bos-airport-from">
                  <label htmlFor="l-bos-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-bos-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-bos-airport-to">
                  <label htmlFor="l-bos-airport-to">
                    Return date & time
                  </label>
                  <input id="l-bos-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-bos-airport-age">
                    Driver age
                  </label>
                   <select id="l-bos-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-bos-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-bos-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
