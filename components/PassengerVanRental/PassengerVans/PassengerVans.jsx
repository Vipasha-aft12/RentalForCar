import './PassengerVans.css';
export default function PassengerVans() {
  return (
    <section className="hero">
      <div className="wrap" style={{maxWidth: '860px'}}>
        ...
        <p className="sub" style={{maxWidth: '48ch'}}>
          Teams, weddings and big families — a passenger van keeps everyone together. The 15-seaters carry the most rules, so check first.
        </p>
        <div className="cta">
