       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           <div className="detail-main">
             ...
             <h1 className="h-1">
              Car rental at O'Hare Airport
            </h1>
             <p className="lede">
              O'Hare keeps its rental cars in a Multi-Modal Facility reached by the airport train. Illinois tolls are entirely cashless, which is the single most common surprise on a Chicago rental bill.
            </p>
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Chicago O'Hare International Airport (ORD)">
               <p className="eyebrow">
                Book at ORD
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-ord-airport-pickup">
                 <label htmlFor="l-ord-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-ord-airport-pickup" type="text" value="Chicago O'Hare International Airport (ORD)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-ord-airport-from">
                  <label htmlFor="l-ord-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-ord-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-ord-airport-to">
                  <label htmlFor="l-ord-airport-to">
                    Return date & time
                  </label>
                  <input id="l-ord-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-ord-airport-age">
                    Driver age
                  </label>
                   <select id="l-ord-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-ord-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-ord-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
