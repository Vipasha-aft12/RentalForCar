import './CarRentalAcrossTheUnitedStates.css';
export default function CarRentalAcrossTheUnitedStates() {
  return (
    <section className="hero">
      <div className="wrap">
        <div className="hero-grid">
          <div>
            <p className="eyebrow">
              Car rental across the United States
            </p>
            <h1>
              Drive more.
              <br />
               ...
               <form className="rsearch" action="/find-a-car/" method="get" role="search">
                <div className="rs-loc">
                  ...
                  <div style={{flex: '1', minWidth: '0'}}>
                    ...
                    <input id="pickup" name="pickup" type="text" list="rfc-locs" autoComplete="off" required placeholder="Any US airport, city, county or ZIP" defaultValue="" />
                  </div>
                </div>
            ...
            <p className="microtrust">
              ...
              We don’t own a fleet — we book with rental companies and quote the all-in total, taxes and fees included.
            </p>
          </div>
          <div>
            ...
            <div className="media" data-label="Hero — car / road photo or video"><img src="https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&w=1200&q=70" alt="Hero — RentalForCar" loading="lazy" width="1200" height="750" /></div>
          </div>
        </div>
      </div>
    </section>
