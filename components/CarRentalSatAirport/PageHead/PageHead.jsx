       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="San Antonio International Airport (SAT)">
               <p className="eyebrow">
                Book at SAT
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-sat-airport-pickup">
                 <label htmlFor="l-sat-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-sat-airport-pickup" type="text" value="San Antonio International Airport (SAT)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-sat-airport-from">
                  <label htmlFor="l-sat-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-sat-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-sat-airport-to">
                  <label htmlFor="l-sat-airport-to">
                    Return date & time
                  </label>
                  <input id="l-sat-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-sat-airport-age">
                    Driver age
                  </label>
                   <select id="l-sat-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-sat-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-sat-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
