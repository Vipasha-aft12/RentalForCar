import './AirportCarRentalCalifornia.css';
export default function AirportCarRentalCalifornia() {
  return (
      ...
      <div className="wrap">
        <div className="hero-grid">
          <div>
            ...
            <p className="sub">
              Los Angeles International. We confirm the consolidated-centre connection and the counter rules before you fly — so you land, collect, and drive.
            </p>
               ...
               <form className="rsearch" action="/find-a-car/" method="get" role="search">
                <div className="rs-loc">
                  ...
                  <div style={{flex: '1', minWidth: '0'}}>
                    ...
                    <input id="pickup" name="pickup" type="text" list="rfc-locs" autoComplete="off" required placeholder="Any US airport, city, county or ZIP" defaultValue="Los Angeles (LAX)" />
                  </div>
                </div>
          ...
          <div>
            <div className="media" data-label="LAX — airport / rental centre photo"><img src="https://images.unsplash.com/photo-1561101904-da649fcbf03f?auto=format&fit=crop&w=1200&q=70" alt="LAX — RentalForCar" loading="lazy" width="1200" height="750" /></div>
