    ...
    <section className="band mint">
       <div className="wrap" style={{maxWidth: '900px'}}>
         ...
         <div className="faq" style={{marginBottom: '40px'}}>
           <details>
             <summary>
              Do I actually need a car in New York?
            </summary>
             <div className="faq-a">
              <p>
                Honestly, not for Manhattan. The subway reaches everywhere and a parked car costs more per night than many hotel rooms. Rent for the day you leave the city — the Hudson Valley, the Catskills, Long Island or New England.
              </p>
            </div>
           </details>
           <details>
             <summary>
              How do tolls and the congestion charge work here?
            </summary>
             <div className="faq-a">
              <p>
                Every crossing into Manhattan is cashless and read electronically, and Manhattan below 60th Street adds a congestion charge on top. Both reach you through the rental company toll programme or as a plate bill with an administration fee attached.
              </p>
            </div>
           </details>
         </div>
