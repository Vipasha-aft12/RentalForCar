       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           ...
           <aside id="search" className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Austin-Bergstrom International Airport (AUS)">
               <p className="eyebrow">
                Book at AUS
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-aus-airport-pickup">
                 <label htmlFor="l-aus-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-aus-airport-pickup" type="text" value="Austin-Bergstrom International Airport (AUS)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-aus-airport-from">
                  <label htmlFor="l-aus-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-aus-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-aus-airport-to">
                  <label htmlFor="l-aus-airport-to">
                    Return date & time
                  </label>
                  <input id="l-aus-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-aus-airport-age">
                    Driver age
                  </label>
                   <select id="l-aus-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-aus-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-aus-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
