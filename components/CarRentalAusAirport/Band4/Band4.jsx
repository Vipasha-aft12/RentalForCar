    ...
    <section className="band dark">
       <div className="wrap" style={{textAlign: 'center', maxWidth: '780px'}}>
         ...
         <p className="card-note" style={{marginTop: '20px'}}>
          RentalForCar is an independent car rental reservation service. Vehicles are supplied and operated by licensed third-party rental companies. We are not affiliated with Austin-Bergstrom International Airport.
        </p>
       </div>
     </section>
  );
