       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Jacksonville International Airport (JAX)">
               <p className="eyebrow">
                Book at JAX
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-jax-airport-pickup">
                 <label htmlFor="l-jax-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-jax-airport-pickup" type="text" value="Jacksonville International Airport (JAX)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-jax-airport-from">
                  <label htmlFor="l-jax-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-jax-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-jax-airport-to">
                  <label htmlFor="l-jax-airport-to">
                    Return date & time
                  </label>
                  <input id="l-jax-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-jax-airport-age">
                    Driver age
                  </label>
                   <select id="l-jax-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-jax-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-jax-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
