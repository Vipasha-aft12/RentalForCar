import './AirportCarRentalColorado.css';
export default function AirportCarRentalColorado() {
  return (
      ...
      <div className="wrap">
        <div className="hero-grid">
          <div>
            ...
            <p className="sub">
              Denver International. We confirm how you reach the cars and your counter’s card, deposit and age rules before you fly — so you land, collect, and drive.
            </p>
               ...
               <form className="rsearch" action="/find-a-car/" method="get" role="search">
                <div className="rs-loc">
                  ...
                  <div style={{flex: '1', minWidth: '0'}}>
                    ...
                    <input id="pickup" name="pickup" type="text" list="rfc-locs" autoComplete="off" required placeholder="Any US airport, city, county or ZIP" defaultValue="Denver (DEN)" />
                  </div>
                </div>
          ...
          <div>
            <div className="media" data-label="DEN — airport / rental centre photo"><img src="https://images.unsplash.com/photo-1570114581742-586696237de1?auto=format&fit=crop&w=1200&q=70" alt="DEN — RentalForCar" loading="lazy" width="1200" height="750" /></div>
