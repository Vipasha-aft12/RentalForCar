import './DebitCardRentals.css';
export default function DebitCardRentals() {
  return (
    <section className="hero">
      <div className="wrap" style={{maxWidth: '860px'}}>
        ...
        <p className="sub" style={{maxWidth: '48ch'}}>
          Plenty of branches take debit — the trick is knowing the conditions before you’re standing at the counter.
        </p>
        <div className="cta">
