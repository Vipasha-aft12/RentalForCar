       ...
       <div className="wrap">
         ...
         <div className="detail-layout">
           ...
           <aside className="detail-aside" data-book-panel="">
             <div className="book-card" data-location-book="" data-location="Phoenix Sky Harbor International Airport (PHX)">
               <p className="eyebrow">
                Book at PHX
              </p>
               <h2 className="h-3">
               ...
               <div className="field" data-validate="l-phx-airport-pickup">
                 <label htmlFor="l-phx-airport-pickup">
                  Pick-up location
                </label>
                 <input id="l-phx-airport-pickup" type="text" value="Phoenix Sky Harbor International Airport (PHX)" autoComplete="off" required />
                 <p className="field-error">
                  Tell us where you're collecting the car.
                </p>
               </div>
               <div className="field-row">
                 <div className="field" data-validate="l-phx-airport-from">
                  <label htmlFor="l-phx-airport-from">
                    Pick-up date & time
                  </label>
                  <input id="l-phx-airport-from" type="datetime-local" required />
                  <p className="field-error">
                    Choose a pick-up date.
                  </p>
                </div>
                 <div className="field" data-validate="l-phx-airport-to">
                  <label htmlFor="l-phx-airport-to">
                    Return date & time
                  </label>
                  <input id="l-phx-airport-to" type="datetime-local" required />
                  <p className="field-error">
               ...
               <div className="field-row">
                 <div className="field">
                   <label htmlFor="l-phx-airport-age">
                    Driver age
                  </label>
                   <select id="l-phx-airport-age">
                    <option>
                      25 or over
                    </option>
                    <option>
                 ...
                 <div className="field">
                   <label htmlFor="l-phx-airport-flight">
                    Flight number (optional)
                  </label>
                   <input id="l-phx-airport-flight" type="text" placeholder="e.g. AA1423" autoComplete="off" />
                 </div>
               </div>
