    ...
    <section className="band mint">
       <div className="wrap" style={{maxWidth: '900px'}}>
         ...
         <div className="faq" style={{marginBottom: '40px'}}>
           <details>
             <summary>
              Will I be charged for tolls I did not know about?
            </summary>
             <div className="faq-a">
              <p>
                South Florida express lanes are electronic only, with no booths to pay at. Every rental car is enrolled in a toll programme, which passes on the tolls plus a daily service charge on the days you use them. Ask what that daily figure is at the counter — it is the single most common surprise on a Miami rental bill.
              </p>
            </div>
           </details>
           <details>
             <summary>
              Is parking in South Beach as bad as people say?
            </summary>
             <div className="faq-a">
              <p>
                It is expensive and tight. Most hotels charge daily for valet and street spaces are metered and scarce. Worth pricing hotel parking before you decide how many days you need the car.
              </p>
            </div>
           </details>
         </div>
