  ...
  return (
    <section className="hero">
      <div className="wrap" style={{maxWidth: '860px'}}>
        ...
        <h1>
          Rentals of 28 days and longer
        </h1>
        <p className="sub" style={{maxWidth: '48ch'}}>
          For extended trips, relocations and work stints, a month-plus rental is often simpler than a lease — as long as you check mileage and how it’s billed.
        </p>
        <div className="cta">
